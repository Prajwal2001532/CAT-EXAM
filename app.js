    ...
    angular.module('myApp', ["ngRoute"])
        ...
        .controller('createController', function ($scope) {
            $scope.createEntry = function () {
                var newData = "{\"Eid\":\"" + $scope.id + "\", \"Ename\":\"" + $scope.name + "\", \"Designation\":\"" + $scope.email + "\", \"Location\":\"" + $scope.item + "\", \"Salary\":\"" + $scope.amount + "\", \"Department\":\"" + $scope.status + "\"}";
        ...
        .controller('updateController', function ($scope, $http) {
            ...
            $scope.updateEntry = function () {
                var newData = "{\"Eid\":\"" + $scope.id['id'] + "\", \"Ename\":\"" + $scope.name + "\", \"Designation\":\"" + $scope.email + "\", \"item\":\"" + $scope.item + "\", \"amount\":\"" + $scope.amount + "\", \"status\":\"" + $scope.status + "\"}";
